...
(setq hass-dash-layout
 '(("Group One" . (("input_boolean.test_boolean" :label "Toggle entity"
                   ...
                   ("switch.bedroom_light" :label "Bedroom Light")
                   ("input_boolean.test_boolean" :label "Turn off test boolean" :service "input_boolean.turn_off")
                   ("automation.some_automation")))
   ("Vacuum Group" . (("vacuum.valetudo_vacuum" :label "Vacuum")
                      ("vacuum.valetudo_vacuum" :label "Vacuum return home"
...
To configure a default *formatter* when one isn't define explicitly provided to a widget, use the variables ~hass-dash-widget-formatter~, ~hass-dash-label-formatter~, ~hass-dash-state-formatter~, and ~hass-dash-icon-formatter~. By default, they're set to the built-in *formatters* that are used to render the dashboard.
